"""Bilingual MCH case-sheet schema (Maternity Services Case Sheet, Bihar).

Sources: State Health Society Bihar maternity case sheet (L1 health centres —
PHC / APHC / HSC). Each field carries English + Hindi labels used both for the
extraction prompt (Gemini) and the dashboard form rendering.
"""
...
FORM_SCHEMA = {
    ...
    "subtitle_en": "L1 Health Centre (PHC/APHC/HSC) · Admission Form · State Health Society, Bihar",
